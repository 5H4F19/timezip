...
export const Buy = ({ navigation }: { navigation: any }) => {
    return (
        <Container>
            <Header title={routes.BUY} navigation={navigation} />
                        ...
                        <View className="flex-1 justify-between space-y-2 my-9">
                            <View className="space-y-2">
                                <View className="group flex flex-row items-center">
                                    <Text className="text-light bg-primary font-['Inter-SemiBold'] text-4xl">USD</Text>
                                    <TextInput
